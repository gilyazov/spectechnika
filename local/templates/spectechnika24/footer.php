...
<?php include($_SERVER["DOCUMENT_ROOT"] . SITE_TEMPLATE_PATH . "/includes/modals/success.php"); ?>
<?php include($_SERVER["DOCUMENT_ROOT"] . SITE_TEMPLATE_PATH . "/includes/modals/error.php"); ?>
